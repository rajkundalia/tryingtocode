...
Serialization: Scan each element in a string, calculate its length and append it with a string and a
element separator or deliminator (the deliminator is ~). We append the length of the string so that we know the length of each element.
...
public class Serialize {
    public static void main(String[] args) {
        System.out.println(serialize(new ArrayList<>(List.of("scaler", "academy"))));
    }
